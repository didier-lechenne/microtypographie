...
function compileRules(settings) {
  ...
  frenchRules.push(
    ...
    {
      reg: new RegExp(`([A-Za-z\xC0-\xD6\xD8-\xF6\xF8-\xFF\u0153\u0152](?:\\s*[!?;:.,])?)\\s*"`, "g"),
...
function applyAllRules(text, rules) {
  ...
  console.log("\u{1F7E6} AVANT r\xE8gles fran\xE7aises:", tempText);
  tempText = applyRules(tempText, rules.frenchRules);
  console.log("\u{1F7E8} APR\xC8S r\xE8gles fran\xE7aises:", tempText);
  tempText = applyRules(tempText, rules.dashRules);
  console.log("\u{1F7E9} APR\xC8S r\xE8gles tirets:", tempText);
  result = tempText;
  ...
  console.log("\u{1F7EA} R\xC9SULTAT FINAL:", result);
  return result;
}
